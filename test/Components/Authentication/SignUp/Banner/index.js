...
import Banner from '../../../../../src/components/Authentication/SignUp/Banner/index';

describe('SignUp Banner Component', () => {
  ...
  it('Should render banner container', function() {
    expect(this.page.find('.signup-banner').length).eq(1);
  });
